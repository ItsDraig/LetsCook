...
const MyRecipesCard = ({ item, handleCardPress}) => {
  ...
  return (
    <View>
      <TouchableOpacity 
      style={[styles.container, {backgroundColor: '#312651'}]}
      ...
      >
        ...
        <Text style={styles.companyName} numberOfLines={1}>
            <FontAwesome name="clock-o" size={19} color="#B3AEC6" style={{ position: 'relative', lineHeight: 25, top: 1 }} />{` ${item.totaltime} mins`}
        </Text>
